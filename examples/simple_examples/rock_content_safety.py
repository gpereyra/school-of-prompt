...
class RockSafetyPrecision(CustomMetric):
    ...
    def calculate(self, predictions, actuals):
        ...
        pred_inappropriate = [1 if 'inappropriate' in str(p).lower() else 0 for p in predictions]
        actual_inappropriate = [1 if 'inappropriate' in str(a).lower() else 0 for a in actuals]
